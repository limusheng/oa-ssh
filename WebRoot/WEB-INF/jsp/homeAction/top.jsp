...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:white; font-size:28px; font-family: 华文隶书">甘肃中医药大学</font> 
        ...
        <div id="Head1Right_Button">
        	...
        	<a target="desktop" href="ItcastOA11/userAction_loginUI.action;"><img width="65" height="20" alt="显示桌面" src="${pageContext.request.contextPath}/style/blue/images/top/desktop.gif" /></a>
        </div>
	</div>
