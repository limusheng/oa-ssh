...
<html>
<head>
	<title>您已退出ganzhongda OA系统</title>
			...
			<td align=center>
				<div id=Logout>
					...
					<div id=LogoutOperate>
                        ...
                        <!-- <a href="javascript:void(0);" onclick="window.opener=null; window.open('','_self');window.close();">关闭当前窗口</a>  -->
                        <a href="javascript:open(location, '_self').close();">关闭当前窗口</a> 
                    </div>
				</div>
			</td>
		</tr>
